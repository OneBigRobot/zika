...
var selectPregnancyOption = function() {
  $(document).on('click', '.pgStep__pregnancy-ok', function() {
    ...
    if ($(".pgArticle").width() < tabletTreshold) {
      ...
      setTimeout(function() {
          alert("ss"+$('.pgConclusions').position().left);
